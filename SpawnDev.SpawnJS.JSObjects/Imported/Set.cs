...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class Set : SpawnJSObject
    {
        #region Constructors
        /// <inheritdoc/>
        public Set(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// <returns></returns>
        public Set<TValue> Add<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TValue>(TValue value) => JSRef!.Call<TValue, Set<TValue>>("add", value);
        /// <summary>
        /// The delete() method of Set instances removes a specified value from this set, if it is in the set.
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public bool Delete<TValue>(TValue value) => JSRef!.Call<TValue, bool>("delete", value);
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public Iterator<Array<TValue>> Entries<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TValue>() => JSRef!.Call<Iterator<Array<TValue>>>("entries");
        /// <summary>
        /// Calls callbackFn once for each value present in the Set object, in insertion order. If a thisArg parameter is provided, it will be used as the this value for each invocation of callbackFn.
        /// </summary>
        /// <param name="callbackFn"></param>
        public void ForEach<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TValue>(ActionCallback<TValue, TValue, Set<TValue>> callbackFn) => JSRef!.CallVoid("forEach", callbackFn);
        /// <summary>
        /// Calls callbackFn once for each value present in the Set object, in insertion order. If a thisArg parameter is provided, it will be used as the this value for each invocation of callbackFn.
        /// </summary>
        /// <param name="callbackFn"></param>
        /// <param name="thisArg"></param>
        public void ForEach<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TValue>(ActionCallback<TValue, TValue, Set<TValue>> callbackFn, SpawnJSObject thisArg) => JSRef!.CallVoid("forEach", callbackFn, thisArg);
        /// <summary>
        /// Returns a boolean asserting whether an element is present with the given value in the Set object or not.
        /// </summary>
        public bool Has<TValue>(TValue value) => JSRef!.Call<TValue, bool>("has", value);
        /// <summary>
        /// An alias for Set.prototype.values().
        /// </summary>
        public Iterator<TValue> Keys<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TValue>() => JSRef!.Call<Iterator<TValue>>("keys");
        /// <summary>
    ...
    /// https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Set
    /// </summary>
    public class Set<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] TValue> : Set
    {
        #region Constructors
        /// <inheritdoc/>
        public Set(SpawnJSObjectReference _ref) : base(_ref) { }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        public Set<TValue> Add(TValue value) => JSRef!.Call<TValue, Set<TValue>>("add", value);
        /// <summary>
        /// The delete() method of Set instances removes a specified value from this set, if it is in the set.
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        public bool Delete(TValue value) => JSRef!.Call<TValue, bool>("delete", value);
        /// <summary>
        /// Returns a new iterator object that contains an array of [value, value] for each element in the Set object, in insertion order. This is similar to the Map object, so that each entry's key is the same as its value for a Set.
        /// </summary>
        /// <returns></returns>
        ...
        /// <param name="callbackFn"></param>
        /// <param name="thisArg"></param>
        public void ForEach(ActionCallback<TValue, TValue, Set<TValue>> callbackFn, SpawnJSObject thisArg) => JSRef!.CallVoid("forEach", callbackFn, thisArg);
        /// <summary>
        /// Returns a boolean asserting whether an element is present with the given value in the Set object or not.
        /// </summary>
        public bool Has(TValue value) => JSRef!.Call<TValue, bool>("has", value);
        /// <summary>
        /// An alias for Set.prototype.values().
        /// </summary>
