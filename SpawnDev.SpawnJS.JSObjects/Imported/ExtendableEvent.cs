...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class ExtendableEvent : Event
    {
        ...
        public ExtendableEvent(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        public ExtendableEvent(string type, EventOptions? options = null) : base(options == null ? JS.New(nameof(ExtendableEvent), type) : JS.New(nameof(ExtendableEvent), type, options)) { }
        /// <summary>
