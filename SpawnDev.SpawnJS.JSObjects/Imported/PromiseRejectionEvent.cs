...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class PromiseRejectionEvent : Event
    {
        ...
        public PromiseRejectionEvent(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        /// A value or Object indicating why the promise was rejected, as passed to Promise.reject().
        /// </summary>
        /// <typeparam name="T"></typeparam>
        /// <returns></returns>
        public T ReasonAs<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>() => JSRef!.Get<T>("reason");
        /// <summary>
