...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    {
        /// <inheritdoc/>
        public OscillatorNode(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        public void SetPeriodicWave(PeriodicWave periodicWave) => JSRef!.CallVoid("setPeriodicWave", periodicWave);
