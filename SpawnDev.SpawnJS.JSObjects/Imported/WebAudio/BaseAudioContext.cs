...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    {
        /// <inheritdoc/>
        public BaseAudioContext(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// </summary>
        public StereoPannerNode CreateStereoPanner() => JSRef!.Call<StereoPannerNode>("createStereoPanner");
        /// <summary>
        /// Creates a WaveShaperNode, which is used to create non-linear distortion effects.
        /// </summary>
        public WaveShaperNode CreateWaveShaper() => JSRef!.Call<WaveShaperNode>("createWaveShaper");
        /// <summary>
        /// Creates a DynamicsCompressorNode, which can be used to apply a compression effect to your audio.
        /// </summary>
        public DynamicsCompressorNode CreateDynamicsCompressor() => JSRef!.Call<DynamicsCompressorNode>("createDynamicsCompressor");
        /// <summary>
