...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class KeyboardEvent : UIEvent
    {
        ...
        public KeyboardEvent(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        public KeyboardEvent(string type, KeyboardEventOptions? options = null) : base(options == null ? JS.New(nameof(KeyboardEvent), type) : JS.New(nameof(KeyboardEvent), type, options)) { }
        /// <summary>
