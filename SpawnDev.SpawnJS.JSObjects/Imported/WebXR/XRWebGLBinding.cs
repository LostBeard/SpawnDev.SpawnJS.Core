...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class XRWebGLBinding : SpawnJSObject
    {
        /// <inheritdoc/>
        public XRWebGLBinding(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public XRCubeLayer CreateCubeLayer(XRCubeLayerInit options) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRCubeLayerInit, XRCubeLayer>("createCubeLayer", options);
        /// <summary>
        ...
        /// <returns></returns>
        public XRCylinderLayer CreateCylinderLayer(XRCylinderLayerInit options) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRCylinderLayerInit, XRCylinderLayer>("createCylinderLayer", options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public XRProjectionLayer CreateProjectionLayer(XRProjectionLayerInit options) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRProjectionLayerInit, XRProjectionLayer>("createProjectionLayer", options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public XRQuadLayer CreateQuadLayer(XRQuadLayerInit options) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRQuadLayerInit, XRQuadLayer>("createQuadLayer", options);
        /// <summary>
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public XREquirectLayer CreateEquirectLayer(XREquirectLayerInit options) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XREquirectLayerInit, XREquirectLayer>("createEquirectLayer", options);
        /// <summary>
        /// Returns an XRWebGLDepthInformation object containing WebGL depth information.
        /// </summary>
        /// <returns></returns>
        public XRWebGLDepthInformation GetDepthInformation(XRView view) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRView, XRWebGLDepthInformation>("getDepthInformation", view);
        /// <summary>
        ...
        /// <returns></returns>
        public WebGLTexture GetReflectionCubeMap(XRLightProbe lightProbe) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRLightProbe, WebGLTexture>("getReflectionCubeMap", lightProbe);
        /// <summary>
        ...
        public XRWebGLSubImage GetSubImage(XRCompositionLayer layer, XRFrame frame, string eye) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRCompositionLayer, global::SpawnDev.SpawnJS.JSObjects.XRFrame, string, XRWebGLSubImage>("getSubImage", layer, frame, eye);
        /// <summary>
        /// The getSubImage() method of the XRWebGLBinding interface returns a XRWebGLSubImage object representing the WebGL texture to render.
        /// </summary>
        /// <param name="layer">The XRCompositionLayer to use for rendering (can be all types of XRCompositionLayer objects except XRProjectionLayer, see XRWebGLBinding.getViewSubImage() for rendering projection layers).</param>
        /// <param name="frame">The XRFrame frame to use for rendering.</param>
        /// <returns>A XRWebGLSubImage object.</returns>
        public XRWebGLSubImage GetSubImage(XRCompositionLayer layer, XRFrame frame) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRCompositionLayer, global::SpawnDev.SpawnJS.JSObjects.XRFrame, XRWebGLSubImage>("getSubImage", layer, frame);
        /// <summary>
        ...
        /// <returns>A XRWebGLSubImage object.</returns>
        public XRWebGLSubImage GetViewSubImage(XRProjectionLayer layer, XRView view) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRProjectionLayer, global::SpawnDev.SpawnJS.JSObjects.XRView, XRWebGLSubImage>("getViewSubImage", layer, view);
    }
}
