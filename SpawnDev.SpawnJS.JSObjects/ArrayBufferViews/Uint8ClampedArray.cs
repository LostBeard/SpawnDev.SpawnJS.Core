namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class Uint8ClampedArray : TypedArray<byte>
    {
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public static Uint8ClampedArray From<T>(IEnumerable<T> values) where T : struct => JS.Call<IEnumerable<T>, Uint8ClampedArray>($"{nameof(Uint8ClampedArray)}.from", values);
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public Uint8ClampedArray(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// <returns></returns>
        public Uint8ClampedArray Slice(long start) => JSRef!.Call<long, Uint8ClampedArray>("slice", start);
        /// <summary>
        /// Extracts a section of an array and returns a new array. See also Array.prototype.slice().
        /// </summary>
        /// <param name="start"></param>
        ...
        /// <returns></returns>
        public Uint8ClampedArray Slice(long start, long end) => JSRef!.Call<long, long, Uint8ClampedArray>("slice", start, end);
        /// <summary>
        ...
        /// <returns></returns>
        public Uint8ClampedArray SubArray(long start) => JSRef!.Call<long, Uint8ClampedArray>("subarray", start);
        /// <summary>
        /// The subarray() method of TypedArray instances returns a new typed array on the same ArrayBuffer store and with the same element types as this typed array. The begin offset is inclusive and the end offset is exclusive.
        /// </summary>
        /// <param name="start">Element to begin at. The offset is inclusive. The whole array will be included in the new view if this value is not specified.</param>
        ...
        /// <returns></returns>
        public Uint8ClampedArray SubArray(long start, long end) => JSRef!.Call<long, long, Uint8ClampedArray>("subarray", start, end);
    }
}
