namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class Int8Array : TypedArray<sbyte>
    {
        ...
        /// <param name="values"></param>
        /// <returns></returns>
        public static Int8Array From<T>(IEnumerable<T> values) where T : struct => JS.Call<IEnumerable<T>, Int8Array>($"{nameof(Int8Array)}.from", values);
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public Int8Array(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// <returns></returns>
        public Int8Array Slice(long start) => JSRef!.Call<long, Int8Array>("slice", start);
        /// <summary>
        /// Extracts a section of an array and returns a new array. See also Array.prototype.slice().
        /// </summary>
        /// <param name="start"></param>
        ...
        /// <returns></returns>
        public Int8Array Slice(long start, long end) => JSRef!.Call<long, long, Int8Array>("slice", start, end);
        /// <summary>
        ...
        /// <returns></returns>
        public Int8Array SubArray(long start) => JSRef!.Call<long, Int8Array>("subarray", start);
        /// <summary>
        /// The subarray() method of TypedArray instances returns a new typed array on the same ArrayBuffer store and with the same element types as this typed array. The begin offset is inclusive and the end offset is exclusive.
        /// </summary>
        /// <param name="start">Element to begin at. The offset is inclusive. The whole array will be included in the new view if this value is not specified.</param>
        ...
        /// <returns></returns>
        public Int8Array SubArray(long start, long end) => JSRef!.Call<long, long, Int8Array>("subarray", start, end);
    }
}
