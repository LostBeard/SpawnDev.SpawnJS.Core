...
namespace SpawnDev.SpawnJS.Marshaller
{
    ...
    public static class TypeExtensions
    {
        ...
        public static bool IsNumericType(Type type)
        {
            ...
            // 1. Fast O(1) jump table handles 95% of standard numeric types instantly
            switch (Type.GetTypeCode(actualType))
            {
                ...
                default:
                    // 2. Fall back to sequential checks ONLY if TypeCode returns 'Object'
                    return actualType == typeof(Half) ||
                           actualType == typeof(Int128) ||
                           actualType == typeof(UInt128);
            }
        }
        /// <summary>
