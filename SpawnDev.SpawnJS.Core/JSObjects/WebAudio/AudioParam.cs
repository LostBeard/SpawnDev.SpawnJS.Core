...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class AudioParam : SpawnJSObject
    {
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public AudioParam(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// </summary>
        public AudioParam SetValueAtTime(float value, double startTime) => JSRef!.Call<float, double, AudioParam>("setValueAtTime", value, startTime);
        /// <summary>
        /// Schedules a gradual linear change to the value.
        /// </summary>
        public AudioParam LinearRampToValueAtTime(float value, double endTime) => JSRef!.Call<float, double, AudioParam>("linearRampToValueAtTime", value, endTime);
        /// <summary>
        /// Schedules a gradual exponential change to the value. The value must be positive.
        /// </summary>
        public AudioParam ExponentialRampToValueAtTime(float value, double endTime) => JSRef!.Call<float, double, AudioParam>("exponentialRampToValueAtTime", value, endTime);
        /// <summary>
        /// Schedules the start of a change to the value, following an exponential approach to a target value at a given rate.
        /// </summary>
        public AudioParam SetTargetAtTime(float target, double startTime, float timeConstant) => JSRef!.Call<float, double, float, AudioParam>("setTargetAtTime", target, startTime, timeConstant);
        /// <summary>
        /// Schedules the values to follow a set of values defined by a Float32Array scaled to fit into a given interval.
        /// </summary>
        public AudioParam SetValueCurveAtTime(float[] values, double startTime, double duration) => JSRef!.Call<float[], double, double, AudioParam>("setValueCurveAtTime", values, startTime, duration);
        /// <summary>
        /// Cancels all scheduled future changes to the AudioParam.
        /// </summary>
        public AudioParam CancelScheduledValues(double startTime) => JSRef!.Call<double, AudioParam>("cancelScheduledValues", startTime);
        /// <summary>
        /// Cancels all scheduled future changes to the AudioParam but holds its value at a given time.
        /// </summary>
        public AudioParam CancelAndHoldAtTime(double cancelTime) => JSRef!.Call<double, AudioParam>("cancelAndHoldAtTime", cancelTime);
    }
}
