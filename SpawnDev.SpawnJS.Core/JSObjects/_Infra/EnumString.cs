    ...
    public class EnumString<T> : EnumString where T : struct, Enum
    {
        ...
        public override string? String
        {
            ...
            set
            {
                ...
                // No enum member maps to this string. KEEP it: browsers add enum values over time, so a
                // wrapper written against an older enum still has to be able to report what it was
                // actually given. Discarding it here loses the value outright and makes ToString() empty.
                IsDefined = false;
                _Enum = null;
                _String = value;
            }
