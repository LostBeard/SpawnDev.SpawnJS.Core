...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class Function : SpawnJSObject
    {
        /// <summary>
        /// Create a new instance that wraps the specified Function reference
        /// </summary>
        public Function(SpawnJSObjectReference jsObject) : base(jsObject) { }
        /// <summary>
        ...
        //public T NewApply<T>(object?[]? args = null) => JS.ObjectNew<T>(JSRef!, args);
