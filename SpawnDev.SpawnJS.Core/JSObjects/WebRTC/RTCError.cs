...
{
    /// <summary>
    /// The RTCError interface describes an error which has occurred while handling WebRTC operations. It's based upon the standard DOMException interface that describes general DOM errors.<br/>
    ...
    public class RTCError : DOMException
    {
        ...
        public RTCError(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
