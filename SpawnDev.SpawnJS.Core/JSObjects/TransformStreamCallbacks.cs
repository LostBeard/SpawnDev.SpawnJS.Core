...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class TransformStreamCallbacks : IDisposable
    {
        ...
        public TransformStreamCallbacks(Func<TransformStreamDefaultController, Task>? start = null, Func<SpawnJSObject, TransformStreamDefaultController, Task>? transform = null, Func<TransformStreamDefaultController, Task>? flush = null)
        {
            Start = start != null ? new FuncCallback<TransformStreamDefaultController, Task>(start) : null;
            Transform = transform != null ? new FuncCallback<SpawnJSObject, TransformStreamDefaultController, Task>(transform) : null;
        ...
        /// <param name="transform"></param>
        /// <param name="flush"></param>
        public TransformStreamCallbacks(Action<TransformStreamDefaultController>? start = null, Action<SpawnJSObject, TransformStreamDefaultController>? transform = null, Action<TransformStreamDefaultController>? flush = null)
        {
            Start = start != null ? new ActionCallback<TransformStreamDefaultController>(start) : null;
            Transform = transform != null ? new ActionCallback<SpawnJSObject, TransformStreamDefaultController>(transform) : null;
