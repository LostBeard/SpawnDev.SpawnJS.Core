...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class XRFrame : SpawnJSObject
    {
        /// <inheritdoc/>
        public XRFrame(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        public Task<XRAnchor> CreateAnchor(XRRigidTransform pose, XRSpace space) => JSRef!.CallAsync<global::SpawnDev.SpawnJS.JSObjects.XRRigidTransform, global::SpawnDev.SpawnJS.JSObjects.XRSpace, XRAnchor>("createAnchor", pose, space);
        /// <summary>
        ...
        public bool FillJointRadii(IEnumerable<XRJointSpace> jointSpaces, Float32Array radii) => JSRef!.Call<global::System.Collections.Generic.IEnumerable<global::SpawnDev.SpawnJS.JSObjects.XRJointSpace>, global::SpawnDev.SpawnJS.JSObjects.Float32Array, bool>("fillJointRadii", jointSpaces, radii);
        /// <summary>
        ...
        /// <returns>A boolean indicating if all of the spaces have a valid pose.</returns>
        public bool FillPoses(IEnumerable<XRSpace> spaces, XRSpace baseSpace, Float32Array transforms) => JSRef!.Call<global::System.Collections.Generic.IEnumerable<global::SpawnDev.SpawnJS.JSObjects.XRSpace>, global::SpawnDev.SpawnJS.JSObjects.XRSpace, global::SpawnDev.SpawnJS.JSObjects.Float32Array, bool>("fillPoses", spaces, baseSpace, transforms);
        /// <summary>
        ...
        public XRCPUDepthInformation GetDepthInformation(XRView view) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRView, XRCPUDepthInformation>("getDepthInformation", view);
        /// <summary>
        ...
        /// <returns></returns>
        public XRHitTestResult[] GetHitTestResults(XRHitTestSource hitTestSource) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRHitTestSource, XRHitTestResult[]>("getHitTestResults", hitTestSource);
        /// <summary>
        ...
        /// <returns></returns>
        public XRJointPose GetJointPose(XRJointSpace joint, XRSpace baseSpace) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRJointSpace, global::SpawnDev.SpawnJS.JSObjects.XRSpace, XRJointPose>("getJointPose", joint, baseSpace);
        /// <summary>
        ...
        /// <returns></returns>
        public XRLightEstimate? GetLightEstimate(XRLightProbe lightProbe) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRLightProbe, XRLightEstimate?>("getLightEstimate", lightProbe);
        /// <summary>
        ...
        /// <param name="baseSpace"></param>
        /// <returns></returns>
        public XRPose GetPose(XRSpace space, XRSpace baseSpace) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRSpace, global::SpawnDev.SpawnJS.JSObjects.XRSpace, XRPose>("getPose", space, baseSpace);
        /// <summary>
        ...
        /// <returns></returns>
        public XRViewerPose GetViewerPose(XRReferenceSpace referenceSpace) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRReferenceSpace, XRViewerPose>("getViewerPose", referenceSpace);
        /// <summary>
        ...
        /// <returns></returns>
        public XRTransientInputHitTestResult[] GetHitTestResultsForTransientInput(XRTransientInputHitTestSource hitTestSource) => JSRef!.Call<global::SpawnDev.SpawnJS.JSObjects.XRTransientInputHitTestSource, XRTransientInputHitTestResult[]>("getHitTestResultsForTransientInput", hitTestSource);
        /// <summary>
