...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class XRRay : SpawnJSObject
    {
        static SpawnJSObjectReference GetReference(DOMPointInit? origin = null, XRRayDirectionInit? direction = null)
        {
        ...
        /// <inheritdoc/>
        public XRRay(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
