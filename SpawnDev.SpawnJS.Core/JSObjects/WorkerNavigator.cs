...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class WorkerNavigator : SpawnJSObject
    {
        /// <summary>
        /// Returns the global navigator instance
        /// </summary>
        public WorkerNavigator() : base(JS.Get<SpawnJSObjectReference>("navigator")) { }
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public WorkerNavigator(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
