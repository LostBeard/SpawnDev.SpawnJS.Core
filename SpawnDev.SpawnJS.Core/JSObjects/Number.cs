...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class Number : SpawnJSObject
    {
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public Number(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// <summary>
        /// Internal method that gets the underlying SpawnJSObjectReference for this Number
        /// </summary>
        /// <param name="value"></param>
        /// <returns></returns>
        private static SpawnJSObjectReference FromDouble(double value)
        {
            if (double.IsNaN(value))
            {
                return JS.Get<SpawnJSObjectReference>("Number.NaN");
            }
            else
            {
                using var float64Array = new Float64Array(1);
                float64Array.Write([value]);
                return float64Array.JSRef!.Get<SpawnJSObjectReference>(0);
            }
        }
        /// <summary>
