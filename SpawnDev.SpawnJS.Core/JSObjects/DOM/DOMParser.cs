...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class DOMParser : SpawnJSObject
    {
        #region Constructors
        /// <summary>
        ...
        /// <inheritdoc/>
        public DOMParser(SpawnJSObjectReference _ref) : base(_ref) { }
        #endregion
        /// <summary>
        ...
        /// - image/svg+xml</param>
        /// <returns></returns>
        public Document ParseFromString(string input, string mimeType) =>JSRef!.Call<string, string, Document>("parseFromString", input, mimeType);
        /// <summary>
