...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class Navigator : SpawnJSObject
    {
        /// <summary>
        /// Gets the global Navigator instance
        /// </summary>
        public Navigator() : base(JS.Get<SpawnJSObjectReference>("navigator")) { }
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public Navigator(SpawnJSObjectReference _ref) : base(_ref) { }
        #region Properties
        /// <summary>
        ...
        static bool? GetBatterySupported = null;
        /// <summary>
        ...
        /// </summary>
        public bool SendBeacon(string url) => JSRef!.Call<string, bool>("sendBeacon", url);
        /// <summary>
        /// The navigator.sendBeacon() method asynchronously sends an HTTP POST request containing a small amount of data to a web server.
        /// </summary>
        ...
        /// </summary>
        public bool Vibrate(Union<float, float[]> pattern) => JSRef!.Call<global::SpawnDev.SpawnJS.Union<float, float[]>, bool>("vibrate", pattern);
        #endregion
    }
}
