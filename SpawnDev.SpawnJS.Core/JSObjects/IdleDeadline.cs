...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class IdleDeadline : SpawnJSObject
    {
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public IdleDeadline(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// </summary>
        /// <returns></returns>
        public double TimeRemaining() => JSRef!.Call<double>("timeRemaining");
        /// <summary>
