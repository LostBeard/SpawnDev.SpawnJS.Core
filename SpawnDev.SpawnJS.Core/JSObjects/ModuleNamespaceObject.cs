...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class ModuleNamespaceObject : SpawnJSObject
    {
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public ModuleNamespaceObject(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        ...
        /// <returns></returns>
        public T GetExport<[DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] T>(string exportName) => JSRef!.Get<T>(exportName);
        /// <summary>
        ...
        /// <returns>A <see cref="SpawnJSObject"/> representing the requested export.</returns>
        public SpawnJSObject GetExport(string exportName) => JSRef!.Get<SpawnJSObject>(exportName);
        /// <summary>
