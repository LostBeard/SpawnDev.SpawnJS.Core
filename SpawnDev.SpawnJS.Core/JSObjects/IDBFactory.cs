...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    /// </summary>
    public class IDBFactory : SpawnJSObject
    {
        /// <summary>
        /// Deserialization constructor
        /// </summary>
        /// <param name="_ref"></param>
        public IDBFactory(SpawnJSObjectReference _ref) : base(_ref) { }
        /// <summary>
        /// Returns the global instance indexedDB
        /// </summary>
        public IDBFactory() : base(JS.Get<SpawnJSObjectReference>("indexedDB")) { }
        /// <summary>
