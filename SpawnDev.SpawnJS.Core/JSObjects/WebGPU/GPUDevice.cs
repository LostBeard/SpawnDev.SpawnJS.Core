...
namespace SpawnDev.SpawnJS.JSObjects
{
    ...
    public class GPUDevice : EventTarget
    {
        #region Constructors
        /// <inheritdoc/>
        public GPUDevice(SpawnJSObjectReference _ref) : base(_ref) { }
        #endregion
        ...
        /// <summary>
        /// Returns the primary GPUQueue for the device. Cached to avoid creating a new SpawnJSObject wrapper on each access.
        /// </summary>
