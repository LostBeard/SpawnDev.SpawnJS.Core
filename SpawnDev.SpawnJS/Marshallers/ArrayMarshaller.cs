...
namespace SpawnDev.SpawnJS.Marshallers
{
    ...
    public class ArrayMarshaller<TElement> : JSMarshallerFromSpawnJSObjectReference<TElement[]?>
    {
        ...
        /// <inheritdoc/>
        public override TElement[]? JSToNet(Type type, SpawnJSObjectReference value1)
        {
        ...
        /// <inheritdoc/>
        public override void NetToJS(Type type, SpawnJSObjectReference jsParent, double jsKey, TElement[]? objects)
        {
        ...
        /// <inheritdoc/>
        public override void NetToJS(Type type, SpawnJSObjectReference jsParent, string jsKey, TElement[]? objects)
        {
            // Build a fresh JS array, write each element into it, then assign it to the parent property.
            if (objects == null) { jsParent.PropertySetNull(jsKey); return; }
            using var outArray = JS.NewJSArray();
