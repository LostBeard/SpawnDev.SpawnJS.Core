namespace SpawnDev.SpawnJS
{
    public class FuncCallback<TResult> : Callback
    {
        ...
        public FuncCallback(Func<TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
    ...
    public class FuncCallback<T1, TResult> : Callback
    {
        ...
        public FuncCallback(Func<T1, TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
    ...
    public class FuncCallback<T1, T2, TResult> : Callback
    {
        ...
        public FuncCallback(Func<T1, T2, TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
    ...
    public class FuncCallback<T1, T2, T3, TResult> : Callback
    {
        ...
        public FuncCallback(Func<T1, T2, T3, TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
    ...
    public class FuncCallback<T1, T2, T3, T4, TResult> : Callback
    {
        ...
        public FuncCallback(Func<T1, T2, T3, T4, TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
    ...
    public class FuncCallback<T1, T2, T3, T4, T5, TResult> : Callback
    {
        ...
        public FuncCallback(Func<T1, T2, T3, T4, T5, TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
    ...
    public class FuncCallback<T1, T2, T3, T4, T5, T6, TResult> : Callback
    {
        ...
        public FuncCallback(Func<T1, T2, T3, T4, T5, T6, TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
    ...
    public class FuncCallback<T1, T2, T3, T4, T5, T6, T7, TResult> : Callback
    {
        ...
        public FuncCallback(Func<T1, T2, T3, T4, T5, T6, T7, TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
    ...
    public class FuncCallback<T1, T2, T3, T4, T5, T6, T7, T8, TResult> : Callback
    {
        ...
        public FuncCallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
    ...
    public class FuncCallback<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> : Callback
    {
        ...
        public FuncCallback(Func<T1, T2, T3, T4, T5, T6, T7, T8, T9, TResult> func, bool once = false) : base(func, once)
        {
            _callback = func;
        }
        /// <summary>
